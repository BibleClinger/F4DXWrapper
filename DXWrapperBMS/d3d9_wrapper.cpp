...
{
#pragma D9EXPORT
	// BMS never calls this function as of 4.34.3, but it needs to be found as anyway as part of the d3d9.dll.
	// It's implemented just because.
	d3d9_manager& m = d3d9_manager::getManager();
	D9Real::IDirect3D9 * pRIDirect3D9 = NULL;
	D9Wrapper::IDirect3D9 * pWIDirect3D9 = NULL;
...
#pragma D9EXPORT
	d3d9_manager& m = d3d9_manager::getManager();
	D9Real::IDirect3D9Ex* pRIDirect3D9Ex = NULL;
	HRESULT hr;
