...
#pragma F4DX_EXPORT
	...
	hr = real_D3D11CreateDevice(pAdapter, DriverType, Software, Flags, pFeatureLevels, FeatureLevels, SDKVersion, ppDevice, pFeatureLevel, ppImmediateContext);
	if (hr == S_OK)
	{
		// TODO: This is probably where we want to hook.
	}
	return hr;
}
...
#pragma F4DX_EXPORT
	...
	real_D3D11CreateDeviceAndSwapChain = reinterpret_cast<fnD3D11CreateDeviceAndSwapChain>(F4DX_manager::getManager().loadFunction(szRealDLLPath, "D3D11CreateDevice"));
